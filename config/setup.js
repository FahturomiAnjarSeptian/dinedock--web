...
const initDatabase = () => {
    ...
    const seedMenus = `REPLACE INTO menus (id, name, description, price, category, image_url) VALUES 
        (1, 'Salmon Sashimi Supreme', 'Irisan ikan salmon segar Norwegia.', 85000, 'food', '/img/salmon.jpg'),
        (2, 'Wagyu Beef Steak', 'Daging sapi Wagyu A5.', 250000, 'food', '/img/wagyu.jpg'),
        ...
        (5, 'Dragon Roll Sushi', 'Sushi roll isi udang tempura.', 55000, 'food', '/img/sushi.jpg'),
        (6, 'Matcha Latte', 'Teh hijau asli Jepang.', 35000, 'beverage', '/img/matcha.jpg'),
        ...
        (9, 'Ogura Ice Cream', 'Es krim kacang merah.', 25000, 'dessert', '/img/ogura.jpg')`;
    db.query(seedMenus);
